...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/LaunchTemplateVersion"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("launchtemplateversions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.LaunchTemplateVersion{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.LaunchTemplateVersion),
	}
}
