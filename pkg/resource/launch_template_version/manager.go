...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=launchtemplateversions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=launchtemplateversions/status,verbs=get;update;patch
