...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/NetworkACL"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("networkacls")
