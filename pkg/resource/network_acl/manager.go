...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkacls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=networkacls/status,verbs=get;update;patch
